// src/components/EarphoneDetail.jsx
...
const EarphoneDetail = ({ products, cartItems, setCartItems, onCartClick }) => {
  const { id } = useParams();
  const navigate = useNavigate();
  const [quantity, setQuantity] = useState(1);

  console.log("EarphoneDetail rendered, onCartClick:", !!onCartClick);
  ...
  const relatedCategories = ["earphones", "headphones", "speakers"];
  ...
  while (
    ...
    if (productToAdd) relatedProducts.push(productToAdd);
    else break;
  }
